...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Order o1 = new Order(null, Instant.now(), OrderStatus.AWAITING_PAYMENT.getCode(), c1);
        Order o2 = new Order(null, Instant.now(), OrderStatus.PAYMENT_CONFIRMED.getCode(), c2);
